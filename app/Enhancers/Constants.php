...
defined('APP_NAME')
    ? null
    : define('APP_NAME', 'MAP - Mergers & Acquisition Platform');
...
defined('BE_LAYOUT_ASSETS')
    ? null
    : define('BE_LAYOUT_ASSETS', ASSETS . 'backend' . DS . 'layout' . DS);

defined('BE_LAYOUT_CSS')
    ? null
    : define('BE_LAYOUT_CSS', BE_LAYOUT_ASSETS . 'css' . DS);

defined('BE_LAYOUT_IMAGE')
    ? null
    : define('BE_LAYOUT_IMAGE', BE_LAYOUT_ASSETS . 'images' . DS);

defined('BE_LAYOUT_JS')
    ? null
    : define('BE_LAYOUT_JS', BE_LAYOUT_ASSETS . 'javascript' . DS);

defined('BE_LAYOUT_PLUGIN')
    ? null
    : define('BE_LAYOUT_PLUGIN', BE_LAYOUT_ASSETS . 'plugins' . DS);
defined('BE_LAYOUT_MEDIA')
    ? null
    : define('BE_LAYOUT_MEDIA', BE_LAYOUT_ASSETS . 'media' . DS);

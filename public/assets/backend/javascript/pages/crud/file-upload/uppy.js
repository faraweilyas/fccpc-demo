...
var KTUppy = function () {
	...
	var initUppy = function(id){
		// Uppy variables
        // For more info refer: https://uppy.io/
		var elemId = 'kt_uppy_'+id;
		var id = '#' + elemId;
		...
		$(id + ' .uppy-FileInput-container').append('<label class="uppy-input-label btn btn-light-primary btn-sm btn-bold" for="' + (elemId + '_input_control') + '">Attach file</label>');

...
!function(n){"use strict";var i="$",t="",e="",r="",a="",s="",p="";function c(t){var i=t.toString().split(".");return i[0]=i[0].replace(/\B(?=(\d{3})+(?!\d))/g," "),i.join(".")}function u(t){var i=0,n=t.match(/(\d+)/g),e="";for(i=0;i<n.length;i++)e+=n[i];return e}function o(){var t=0;n(".to-calc").each(function(){e=u(n(".price",this).val()),s=n(".sub-sum",this).val(),a=n(".quantity",this).val(),s=void 0!==a?1*e*(1*a):(r=u(n(".extra-option",this).val()),n(".extra-option",this).is(":checked")?1*r:1*(r=0)),n(".sub-sum",this).val(c(s)+" "+i),t+=s}),n(".total-sum").val(c(t)+" "+i)}n(".to-calc").each(function(){e=u(n(".price",this).val()),n(".price",this).val(e+" "+i),s=u(n(".sub-sum",this).val()),n(".sub-sum",this).val(s+" "+i),p=u(n(".total-sum").val()),n(".total-sum").val(p+" "+i)}),n(".to-calc input").keypress(function(t){8!=t.which&&isNaN(String.fromCharCode(t.which))&&t.preventDefault()}),n(".to-calc .extra-option").click(o),n(".to-calc input").keyup(o),n(".btn-generate").click(function(){n("#inputOrderList").empty(),n(".to-calc").each(function(){t=n(".item-name",this).val(),e=u(n(".price",this).val())+" "+i,a=n(".quantity",this).val(),s=n(".sub-sum",this).val(),void 0!==a?0<a.length&&(n("#inputOrderList").append(t+"\n"),n("#inputOrderList").append("Price: "+e+"\n"),n("#inputOrderList").append("Quantity: "+a+"\n"),n("#inputOrderList").append("Sub Sum: "+s+"\n"),n("#inputOrderList").append("--\n")):n(".extra-option",this).is(":checked")&&(n("#inputOrderList").append(t+": YES\n"),n("#inputOrderList").append("Price: "+e+"\n"),n("#inputOrderList").append("--\n"))}),n("#inputOrderList").append("TOTAL : "+n(".total-sum").val())}),n(".btn-reset").click(function(){n("#inputOrderList").empty()}),n("#orderForm").parsley(),n("#orderForm").attr("action","order_send.php"),n('a[href^="#"]').click(function(t){t.preventDefault();var i=n(n(this).attr("href")).offset().top-150;n("body, html").animate({scrollTop:i})})}(window.jQuery);
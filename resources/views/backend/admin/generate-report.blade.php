                    ...
                    <div class="card__box card__box__large  rmv-height add-mgbottom " id="applications">
                        ...
                        <div class="card__box__large-content">
                            <div class="form-group">
                                ...
                                <input
                                    type="text" id="start_date_end_date"
                                    class="form-control"
                            ...
                            @else
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <select
                                            class="form-control form-control-table select2"
                                            id="get_handler"
                                            name="handler_id[]"
                                            style="width: 100%;"
                                            multiple="multiple"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-right">
                                    <span>
                                        <button class="btn btn-success-ts no-border mx-5 toggle-report">
                                            New Report
                                        </button>
                                    </span>
                                    <span class="float-right">
                                        <button
                                            ...
                                            onclick="window.location.href='{{ route('dashboard.report.export', ['start_date_end_date' => $_GET['start_date_end_date'], 'category' => $_GET['category'], 'type' => $_GET['type']]) }}';">
                                            Export CSV
                                        </button>
                                    </span>
                                </div>

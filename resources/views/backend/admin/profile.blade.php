                                                            ...
                                                            <div class="symbol symbol-45 symbol-light-danger mr-4 flex-shrink-0">
                                                                <div class="symbol-label">
                                                                    <span class="svg-icon svg-icon-lg svg-icon-danger">
                                                                        <x-icons.lines></x-icons.lines>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <div class="font-size-h4 text-dark-75 font-weight-bolder">706</div>
                                                                <div class="font-size-sm text-muted font-weight-bold mt-1">Cases On Hold</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="d-flex align-items-center mr-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="font-size-sm text-muted font-weight-bold mt-1">Ongoing Cases</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="d-flex align-items-center mr-2">
                                                            ...
                                                            <div>
                                                                <div class="font-size-h4 text-dark-75 font-weight-bolder">5</div>
                                                                <div class="font-size-sm text-muted font-weight-bold mt-1">Approved Cases</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="d-flex align-items-center mr-2">
                                                            ...
                                                            <div>
                                                                <div class="font-size-h4 text-dark-75 font-weight-bolder">55</div>

                ...
                <div class="login-signin">
                    ...
                    <form class="form" method="POST" action="{{ route('applicant.confirm.store') }}">
                        ...
                        <button id="kt_login_signin_submit" type="submit"
                            class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">Confirm ID</button>
                    </form>
                    <div class="mt-10">
                        <p>
                            <a href="{{ route('applicant.show') }}" id="kt_login_signup2"
                                class="text-dark text-hover-primary font-weight-bold">Didn't receive it? Resend
                                application ID
                        </p>
                    </div>
                </div>

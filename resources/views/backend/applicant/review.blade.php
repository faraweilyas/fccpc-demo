                ...
                <div class="card__box__large-content">
                    ...
                    <form class="form" id="kt_form">
                        ...
                        <div class="grid-col-2-btn">
                            <button id="goback-btn" class="btn btn-primary font-weight-bold text-uppercase px-9 py-6" onclick="window.location.href = '{{ url('/application')}}/{{$guest->tracking_id }}/{{ $guest->case->case_category }}'">Go back to edit</button>

                        ...
                        <div class="grid-col-2">
                            ...
                            <div class="grid-row-2 d-flex">
                                <div class="d-flex mt-n7">
                                    ...
                                    <img class="mw-10 cr-pointer" src="{{ $case->getLetterOfAppointmentIconText() }}" alt="pdf" height="50px" onclick="window.location.href = '{{ route('applicant.download_contact_loa', ['document' => $case->letter_of_appointment]) }}';"/>
                                    <h4 class="py-5 mx-5 w-75 text-hover-primary cr-pointer" onclick="window.location.href = '{{ route('applicant.download_contact_loa', ['document' => $case->letter_of_appointment]) }}';">Letter Of Appointment</h4>
                                    @else

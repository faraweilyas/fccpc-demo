...
{{-- 
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="d-flex flex-column-fluid">
                 ...
                 <div class="row">
                    <div class="col-md-4">
                        <a href="{{ $guest->createApplicationPath('reg') }}">
                          ...
                          <a href="{{ route('application.checklist') }}" class="checklist-list">View Local Merger Document Checklist</a>
          ...
          <a href="{{ route('application.checklist') }}" class="checklist-list">View Foreign to Foreign Merger Document Checklist</a>
          ...
          <a href="{{ route('application.checklist') }}" class="checklist-list">View Expedited to Expedited Document Checklist</a>

			...
			<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url({{ asset(BE_MEDIA.'bg/bg-3.jpg') }}">
				<div class="login-form text-center p-7 position-relative overflow-hidden">
					...
					<div class="login-signin">
						...
						<div class="mt-10">
	                        <span class="opacity-70 mr-4">Already have an existing application?</span>
	                        <a href="{{ route('applicant.track') }}" id="kt_login_signup2" class="text-muted text-hover-primary font-weight-bold">Add supporting documents!</a>
	                    </div>
					</div>

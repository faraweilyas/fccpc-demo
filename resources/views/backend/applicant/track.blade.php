            ...
            <div class="login-form text-center p-7 position-relative overflow-hidden">
                ...
                <div class="login-signin">
                    <div class="mb_30">
                        ...
                        <div class="font-weight-bold text-black-sm">Add supporting document or continue where you left
                            off</div>
                    </div>
                    <form class="form" method="POST" action="{{ route('applicant.authenticate.track') }}">
                        ...
                        <div class="form-group mb-5">
                            ...
                            @enderror
                            <input type="text" value="{{ old('tracking_id') }}"
                                placeholder="Please provide application id:" name="tracking_id"
                    ...
                    <div class="mt-10">
                        <p>
                            ...
                            <a href="{{ route('applicant.show') }}" id="kt_login_signup2"
                                class=" text-hover-primary font-weight-bold text-black-sm">Submit Application</a>
                        </p>
                    </div>
                </div>
            </div>

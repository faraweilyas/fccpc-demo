            ...
            <div class="card-custom relative">
                ...
                <div class="btn-group">
                    ...
                    <button class="btn btn-success no-border mx-5 px-10 py-4 hide" id="approve-checklists"
                        ...
                        data-analyze-case-route="{{ route('cases.analyze', ['case' => $case->id]) }}">Approve
                        Checklist</button>
                    <button class="btn btn-success no-border mx-5 px-10 py-4 hide" id="approving_checklists" disabled><i
                            class="fas fa-spinner fa-pulse"></i>Approving...</button>
                </div>
            </div>
        </div>
    </div>

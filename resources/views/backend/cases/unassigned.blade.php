    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline mr-5">
                <h5 class="text-dark font-weight-bold my-2 mr-5">New Cases</h5>
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="{{ route('dashboard.index') }}" class="text-muted">Home</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="" class="text-muted">New Cases</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="d-flex flex-column-fluid mt-sm-30 mt-md-30 md-lg-0">
        <div class="container">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap" class="text-center">
                                    ...
                                    <a href="#" class="assignCaseButton{{ $case->id }} btn btn-sm btn-light-info mr-3"
                                        title="Assign Case Handler" data-toggle="modal" data-target="#assignCaseModal">
                                        <i class="flaticon-user-add"></i> Assign
                                    </a>
                                    <a href="#"
                                        class="unassignCaseButton{{ $case->id }} btn btn-sm btn-light-danger mr-3 unassignCaseButton hide"
                                        data-case-id="{{ $case->id }}" title="Unassign Case Handler">
                                        <i class="la la-trash"></i> Unassign
                                    </a>
                                    <a class="unassigningCaseButton{{ $case->id }} btn btn-sm btn-light-danger mr-3 disabled hide"

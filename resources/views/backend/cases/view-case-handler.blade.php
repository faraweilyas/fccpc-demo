                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="label label-lg font-weight-bold label-light-info text-dark label-inline">0</span>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        <span
                                            class="label label-lg font-weight-bold label-light-{{ $handler->getStatusHtml() }} text-white label-inline">
                                            {{ $handler->getStatus() }}
                                        </span>
                                    </p>
                                    <p>
                                        ...
                                        <div class="col-md-6 text-center">
                                            ...
                                            <p>
                                                <a href="{{ route('handlers.update_status', ['id' => $handler->id]) }}">
                                                    <button type="button"
                                                        class="btn btn-danger mr-2">Deactivate</button>
                                                </a>
                                            </p>
                                            @else
                                            <p>
                                        ...
                                        <div class="col-md-6 text-center">
                                            <p>
                                                <button type="button" class="btn btn-info mr-2" data-toggle="modal"
                                                    data-target="#reassignCaseModal">View Cases</button>
                                            </p>
                                        </div>
                                        <div class="col-md-6 text-center">
                                            <p>

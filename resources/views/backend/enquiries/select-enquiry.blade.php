                    ...
                    <a href="{{ route('enquiries.create', ['type' => 'gen']) }}">
                        <div class="card card-custom bg-success gutter-b" style="height: 150px">
                            <div class="card-body">
                                ...
                                <div class="text-inverse-success font-weight-bolder font-size-h2 mt-3">General Enquiry
                                </div>
                    ...
                    <a href="{{ route('enquiries.create', ['type' => 'prn']) }}">
                        <div class="card card-custom gutter-b" style="height: 150px">
                            <div class="card-body">
                                ...
                                <div class="text-dark font-weight-bolder font-size-h2 mt-3">Pre Notification Enquiry
                                </div>

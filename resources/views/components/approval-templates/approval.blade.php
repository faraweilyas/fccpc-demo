        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12 approval_content">
                    ...
                    <p>The Commission is satisfied that the information you have provided is sufficient to determine that the proposed {{ '...' }} will not substantially lessen or prevent competition in the relevant market.</p>

                    <p>The transaction is therefore approved.</p>

                    <p>The decision of the Commission is based, in large part, on the Commission’s reliance on the accuracy of the information provided in support of your request. To the extent that any information provided is inaccurate or untrue, this approval is ineffective and subject to revocation under Section 99(1)(a) and (b) of the Federal Competition and Consumer Protection Act, 2018 (FCCPA). Further applicable regulatory action may be deemed necessary.</p>

                    <p>In the event that any material change(s) have occurred, or are about to occur, with respect to the basis of the notification and/or information provided in support of the notification, you are required to immediately communicate same to the Commission.</p>

                    <p>Please note that the transaction must be implemented within twelve (12) months from the date of this letter. Failure to implement within this time frame may result in a revocation of this approval pursuant to Section 99(1)(c) of the FCCPA.</p>

                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top" class="mcnTextContent"
                                                                    ...
                                                                    <p paraeid="{78a321ea-5ad1-40bb-af05-a2d4b9a4cfe6}{61}"
                                                                        ...
                                                                        Dear {{ $case->getApplicantName() }},</p>

                                                                    <p paraeid="{78a321ea-5ad1-40bb-af05-a2d4b9a4cfe6}{95}"
                                                                        paraid="640540932"
                                                                        style="margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">Find Approval letter for notification <b>#{{ $case->guest->tracking_id }}</b> attached to this mail.</p>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td valign="top" class="mcnTextContent"
                                                                    style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 12px;line-height: 150%;text-align: left;">

                                                                    <p paraeid="{78a321ea-5ad1-40bb-af05-a2d4b9a4cfe6}{138}"
                                                                        paraid="6160621"
        ...
        $(document).ready(function () {
            document.getElementById("copyToClipboard").addEventListener("click", function () {
                ...
                if (successful) {
                    ...
                    throw new Error(
                        "Failed to copy text (verify caller was in the context of an event handler)"
                    );
                }
            });

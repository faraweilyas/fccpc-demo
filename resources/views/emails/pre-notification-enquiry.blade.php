...
<head>
    ...
    <title>Pre-Notification Acknowledgement</title>
    <style type="text/css">
        p {
            margin: 10px 0;
            padding: 0;
...
<body id="archivebody">
    ...
    <body
        ...
        >
            Pre-Notification Acknowledgement
        </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top" class="mcnTextContent"
                                                        ...
                                                        <p paraeid="{78a321ea-5ad1-40bb-af05-a2d4b9a4cfe6}{95}"
                                                            paraid="640540932"
                                                            style="margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
                                                            Your Pre-Notification Consultation enquiry has been submitted. A representative will contact you within 3 working days.</p>
                                                        <p paraeid="{91321d81-9a7a-4045-a280-c85ae145b80c}{240}"
                                                            paraid="1344694371"
                                                            style="margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
                                                            If you have any queries, visit the FAQ section <a href="{{ route('home.faqs.category', ['category' => 'GEN']) }}"

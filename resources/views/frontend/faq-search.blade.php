                    ...
                    <ul class="faq-questions__ul">
                        ...
                        @foreach($related_faq as $related_faq)
                            @if($related_faq->id !== $faq->id)
                                <li class="faq-questions__li">
                                    <a href="{{ $related_faq->path() }}" class="faq-questions__a">
                                        {{ $related_faq->question }}
                                    </a>
                                </li>
                            @endif
                        @endforeach
                ...
                <div class="col-md-9">
                    ...
                    <div class="faq-answer-content">
                        @if(Str::contains($faq->question, 'cost to file'))
                            <a href="{{ route('home.fee.calculator') }}" class="fee__CalculatorLink" __target="blank">Click here to calculate your merger fees</a><br />
                        @endif
                        {!! nl2br($faq->answer) !!}
                    </div>

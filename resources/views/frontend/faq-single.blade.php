          ...
          <div class="col-md-7">
            ...
            <form id="feedback-form" action="{{ route('home.faq.feedback', $faq) }}" method="POST">
                ...
                <div class=" like-article">
                  <div class="like-article-section">
                    <img src="{{ FE_IMAGE.'png/thumbs-up.png' }}" alt="thumbs up" />
                    <a href="#" class="like-article-yes">
                      Yes
                    </a>
                  </div>
                  <div class="unlike-article-section" onclick="document.getElementById('feedback').value = 'no';">
                    <img src="{{ FE_IMAGE.'png/thumbs-down.png' }}" alt="thumbs down" />
                    <a href="#" class="like-article-no"> &nbsp; No</a>
                  </div>
                </div>
            </form>
            <div class="sub-title">

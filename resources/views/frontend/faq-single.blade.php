                ...
                <div class="sub-article-container shaded mb-9 text-center">
                    <div class="as">
                        ...
                        <form action="{{ route('home.faq.feedback', $faq) }}" method="POST">
                            @csrf
                            <input type="text" name="feedback" value="0" />

                            <div class="button-group">
                                <button type="submit" class="as-button" data-value="5">Yes</button>
                                <button type="submit" class="as-button" data-value="1">No</button>
                            </div>
                        </form>
                        <div class="sub-title">

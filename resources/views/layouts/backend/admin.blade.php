  ...
  <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
      ...
      <ul class="menu-nav">
        ...
        <li class="menu-item bb_home" aria-haspopup="true">
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
          <a href="javascript:;" class="menu-link menu-toggle">
            <span class="svg-icon menu-icon">
              <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M8 3V3.5C8 4.32843 8.67157 5 9.5 5H14.5C15.3284 5 16 4.32843 16 3.5V3H18C19.1046 3 20 3.89543 20 5V21C20 22.1046 19.1046 23 18 23H6C4.89543 23 4 22.1046 4 21V5C4 3.89543 4.89543 3 6 3H8Z" fill="#A9B3BE"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M11 2C11 1.44772 11.4477 1 12 1C12.5523 1 13 1.44772 13 2H14.5C14.7761 2 15 2.22386 15 2.5V3.5C15 3.77614 14.7761 4 14.5 4H9.5C9.22386 4 9 3.77614 9 3.5V2.5C9 2.22386 9.22386 2 9.5 2H11Z" fill="#A9B3BE"/>
                <path opacity="0.3" d="M16 9H11C10.4477 9 10 9.44772 10 10C10 10.5523 10.4477 11 11 11H16C16.5523 11 17 10.5523 17 10C17 9.44772 16.5523 9 16 9Z" fill="#A9B3BE"/>
                <path opacity="0.3" d="M9 10C9 9.44772 8.55228 9 8 9C7.44772 9 7 9.44772 7 10C7 10.5523 7.44772 11 8 11C8.55228 11 9 10.5523 9 10Z" fill="#A9B3BE"/>
                <path opacity="0.3" d="M9 14C9 13.4477 8.55228 13 8 13C7.44772 13 7 13.4477 7 14C7 14.5523 7.44772 15 8 15C8.55228 15 9 14.5523 9 14Z" fill="#A9B3BE"/>
                <path opacity="0.3" d="M16 13H11C10.4477 13 10 13.4477 10 14C10 14.5523 10.4477 15 11 15H16C16.5523 15 17 14.5523 17 14C17 13.4477 16.5523 13 16 13Z" fill="#A9B3BE"/>
                <path opacity="0.3" d="M9 18C9 17.4477 8.55228 17 8 17C7.44772 17 7 17.4477 7 18C7 18.5523 7.44772 19 8 19C8.55228 19 9 18.5523 9 18Z" fill="#A9B3BE"/>
                <path opacity="0.3" d="M16 17H11C10.4477 17 10 17.4477 10 18C10 18.5523 10.4477 19 11 19H16C16.5523 19 17 18.5523 17 18C17 17.4477 16.5523 17 16 17Z" fill="#A9B3BE"/>
                </svg>
          ...
          <div class="menu-submenu">
            ...
            <ul class="menu-subnav">
              ...
              <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="{{ in_array(\Auth::user()->account_type, ['SP', 'AD']) ? route('enquiries.logs') : route('enquiries.assigned-logs') }}" class="menu-link menu-toggle">
                  <i class="menu-bullet menu-bullet-line">
                    <span></span>
                  </i>
        ...
        <li class="menu-item " aria-haspopup="true">
          <a href="{{ route('dashboard.report') }}" class="menu-link">
            <span class="svg-icon menu-icon">
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M3.5 21H20.5C21.3284 21 22 20.3284 22 19.5V8.5C22 7.67157 21.3284 7 20.5 7H10L7.43934 4.43934C7.15804 4.15804 6.7765 4 6.37868 4H3.5C2.67157 4 2 4.67157 2 5.5V19.5C2 20.3284 2.67157 21 3.5 21Z" fill="#A9B3BE"/>
                <path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M12 17.2277L9.80187 18.4353C9.53879 18.5798 9.2134 18.4741 9.07509 18.1992C9.02001 18.0897 9.00101 17.9643 9.02102 17.8424L9.44081 15.2846L7.66252 13.4732C7.44968 13.2564 7.44533 12.9004 7.65279 12.6779C7.73541 12.5894 7.84366 12.5317 7.96078 12.5139L10.4183 12.1408L11.5174 9.81362C11.6489 9.53509 11.9716 9.42074 12.2381 9.5582C12.3443 9.61294 12.4302 9.70271 12.4826 9.81362L13.5816 12.1408L16.0391 12.5139C16.3333 12.5586 16.5371 12.844 16.4943 13.1514C16.4773 13.2738 16.4222 13.3869 16.3374 13.4732L14.5591 15.2846L14.9789 17.8424C15.0292 18.1486 14.8324 18.4393 14.5395 18.4918C14.4228 18.5127 14.3028 18.4928 14.1981 18.4353L12 17.2277Z" fill="#A9B3BE"/>
                </svg>
        ...
        <li class="menu-item " aria-haspopup="true">
          <a href="#" class="menu-link">
            <span class="svg-icon menu-icon">
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.3" d="M14.0008 7C14.0008 7.55228 14.4483 8 15.0003 8C15.5524 8 15.9999 7.55228 15.9999 7V6C15.9999 3.79086 14.2098 2 12.0016 2H6.0051C3.79692 2 2.00684 3.79086 2.00684 6L2.00684 18C2.00684 20.2091 3.79692 22 6.0051 22H12.0086C14.2168 22 16.0068 20.2091 16.0068 18V17C16.0068 16.4477 15.5593 16 15.0073 16C14.4552 16 14.0077 16.4477 14.0077 17V18C14.0077 19.1046 13.1127 20 12.0086 20H6.0051C4.90101 20 4.00597 19.1046 4.00597 18L4.00597 6C4.00597 4.89543 4.90101 4 6.0051 4H12.0016C13.1057 4 14.0008 4.89543 14.0008 6V7Z" fill="#1F877A"/>
                <path opacity="0.3" d="M19 13C19.5523 13 20 12.5523 20 12C20 11.4477 19.5523 11 19 11L9 11C8.44771 11 8 11.4477 8 12C8 12.5523 8.44771 13 9 13L19 13Z" fill="#1F877A"/>
                <path d="M17.2929 9.70711C16.9024 9.31658 16.9024 8.68342 17.2929 8.29289C17.6834 7.90237 18.3166 7.90237 18.7071 8.29289L21.7071 11.2929C22.0976 11.6834 22.0976 12.3166 21.7071 12.7071L18.7071 15.7071C18.3166 16.0976 17.6834 16.0976 17.2929 15.7071C16.9024 15.3166 16.9024 14.6834 17.2929 14.2929L19.5858 12L17.2929 9.70711Z" fill="#1F877A"/>
                </svg>

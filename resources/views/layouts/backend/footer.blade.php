...
<script src="{{ pc_asset(BE_PLUGIN.'custom/datatables/datatables.bundle.js') }}"></script>
<script src="{{ pc_asset(BE_JS.'pages/crud/datatables/advanced/column-rendering.js') }}"></script>
...
<script src="{{ pc_asset(BE_JS.'custom.js') }}"></script>

...
<head>
    ...
    <!-- Core CSS file -->
    <link rel="stylesheet" href="{{ asset(FE_CSS.'photoSwipe.css') }}">
    <link rel="stylesheet" href="{{ asset(FE_CSS.'default-skin.css') }}">
    <link rel="canonical" href="{{ agencyLink() }}" />
    <link href="{{ asset(FE_CSS.'flickity.css') }}" rel="stylesheet" />
    <link href="{{ asset(FE_CSS.'style.css') }}" rel="stylesheet" />
    <link href="{{ asset(FE_CSS.'custom.css') }}" rel="stylesheet" />
    <link href="{{ asset(FE_CSS.'custom.min.css') }}" rel="stylesheet" />
    <link rel="canonical" href="{{ agencyLink() }}" />
    <!-- UI JS file -->
    <script src="{{ asset(FE_JS.'photoswipe-ui.min.js') }}"></script>
    <script src="{{ asset(FE_JS.'flickity.pkgd.min.js') }}"></script>

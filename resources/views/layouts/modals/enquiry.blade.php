<div class="modal fade" id="viewEnqiryModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="viewEnqiryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewCaseModalLabel">View Pre-Notifications</h5>

<div class="modal fade" id="viewIDRequestModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="viewIDRequestModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewCaseModalLabel">View Enquiry</h5>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="case_tab" role="tabpanel">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <span class="text-dark" id="subject">...</span>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="font-weight-bold mr-2">Category:</span>
                                    <span class="text-dark" id="category">...</span>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="font-weight-bold mr-2">Type:</span>
                                    <span class="text-dark" id="type">...</span>
                                </div>
                                <div class='mb-1'>
